WITH RawBriefCaseTable AS
	     (SELECT DISTINCT bc.PersonID,
	                      ...
	                      StrahID,
	                      ContractDate,
	                      IIF(ContractAmount = 0, 1, ContractAmount) AS [ContractAmount],
	                      MainDebtAmount,
	                      PercentAmount,
	                      FineAmount,
     ...
     DataSet AS
	     (SELECT DISTINCT bc.PersonID,
	                      ...
	                      MAX(TotalDebtAmount) /
	                      IIF(MIN(TotalDebtAmount) = 0, 1, MIN(TotalDebtAmount))                     [OurMinMaxTotalDebtAmountRatio],
	      ...
	      GROUP BY bc.PersonID, pers.PersonFIO, pers.PersonBirthDate, pers.PersonGenderMale,
	               pers.PersonRegionRegistrationNumber,
	               pct.PersonContractType)
